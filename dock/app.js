...
function renderCalendar() {
  ...
  function dotColor(color) {
    const normalizedColor = normalizeCalendarColorKey(color);
     ...
     return normalizedColor === "green"     ? "#3f9c68"
         : normalizedColor === "rose"      ? "#ae6f7a"
         : normalizedColor === "purple"    ? "#7c6aa2"
         : normalizedColor === "blue"      ? "#5f82b1"
         : normalizedColor === "indigo"    ? "#5b67be"
       : normalizedColor === "amber"     ? "#c99239"
       ...
       : normalizedColor === "slate-neutral" ? "#607693"
         ...
         : normalizedColor === "mocha"     ? "#8b6e59"
       : normalizedColor === "cream"     ? "#a98a63"
